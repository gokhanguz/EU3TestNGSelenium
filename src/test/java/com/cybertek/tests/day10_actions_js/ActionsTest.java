...
public class ActionsTest {
    ...
    public void hoverTest(){
        ...
        //how to create actions object-->passing driver driver as a constructor
        ...
        Assert.assertTrue(viewLink.isDisplayed(),"verify viewLink is display");
    ...
    @Test
    public void dragAndDrogChaining() throws InterruptedException {
        driver.get("https://demos.telerik.com/kendo-ui/dragdrop/index");
        driver.manage().window().maximize();
